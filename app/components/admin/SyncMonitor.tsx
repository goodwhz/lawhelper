    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-gray-900">用户数据同步状态</h2>
        ...
        <div className="mb-4">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2.5">
            <div
              className={`h-2.5 rounded-full ${getProgressBarColor(stats.sync_percentage)}`}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-green-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-green-600">{stats.synced_users}</div>
            <div className="text-sm text-green-800">已同步</div>
          </div>
          <div className="bg-red-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-red-600">{stats.missing_users}</div>
            <div className="text-sm text-red-800">缺失档案</div>
          </div>
          <div className="bg-yellow-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-yellow-600">{stats.email_mismatch_users}</div>
            <div className="text-sm text-yellow-800">邮箱不一致</div>
          </div>
          <div className="bg-orange-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-orange-600">{stats.outdated_users}</div>
            <div className="text-sm text-orange-800">档案过期</div>
          </div>
          <div className="bg-blue-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-blue-600">{stats.login_outdated_users}</div>
            <div className="text-sm text-blue-800">登录时间不同步</div>
          </div>
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="text-2xl font-bold text-gray-600">{stats.total_users}</div>
            <div className="text-sm text-gray-800">总用户数</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
        <h4 className="text-blue-800 font-medium mb-2">同步机制说明</h4>
